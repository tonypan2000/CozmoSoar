...
USAGE
  ...
  Run, and move the checkerboard in the field of view and hit <space> to capture
  images.  When enough images have been captured, press ESC to begin calibration.


  Calibration will be saved to calibration.cfg and Video will now display corrected image.
